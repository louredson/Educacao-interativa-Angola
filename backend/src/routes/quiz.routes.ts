...
// PONTO 3 — lista os quizzes do próprio utilizador (filtra por criado_por,
// por isso é seguro para admin e para utilizadores com pode_criar_quiz)
quizRouter.get('/meus', authenticate, listMeusQuizzes)

// PONTO 4 — geração por IA (devolve payload, não guarda)
// Mesma nota da rota '/completo': a permissão (admin OU pode_criar_quiz)
// é verificada dentro do controller.
quizRouter.post('/gerar-ia', authenticate, gerarQuiz)
