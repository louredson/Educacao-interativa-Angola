    ...
    try {
      if (isLogin) {
        ...
        if (ok) {
          ...
          navigate(cu && JSON.parse(cu)?.isAdmin ? '/admin' : '/');
        } else {
        ...
        if (ok) {
          ...
          setTimeout(() => switchMode(true), 2200);
        } else {
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          opacity:    pageIn ? 1 : 0,
          transform:  pageIn ? 'translateY(0)' : 'translateY(20px)',
                      ...
                      <div className="space-y-1">
                        ...
                        <Field icon={MapPin}>
                          <select value={province} onChange={e => setProvince(e.target.value)}
                            className={inputCls + ' appearance-none'} required={!isLogin}>
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center justify-between">
                      ...
                      {isLogin && (
                        <Link
                          to="/recuperar-senha"
                          className="text-xs text-[#C1121F] hover:text-[#8B0000] font-medium transition-colors"
                          tabIndex={-1}
                        >
                          Esqueceu a senha?
                        </Link>
