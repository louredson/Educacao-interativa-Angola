              ...
              <CardContent>
                <div className="mb-6 flex flex-col sm:flex-row gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <label htmlFor="tipo-filter" className="text-sm font-medium text-slate-700">
                      Filtrar por tipo:
                    </label>
                    <select
                      id="tipo-filter"
                    ...
                    >
                      ...
                      <option value="subscrito">Alunos</option>
                  ...
                  <div className="space-y-3">
                    {ranking
                      .filter(participant => 
                        ...
                        (selectedTipo === 'Todos' || (participant as any).tipo === selectedTipo)
                      )
