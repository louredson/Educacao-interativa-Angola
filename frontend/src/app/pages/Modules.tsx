...
export default function Modules() {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      if (tooltip.visible) {
        setTooltip((prev) => ({ ...prev, x: e.pageX + 15, y: e.pageY - 10 }));
      }
    };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white flex items-center justify-center p-4">
      <div className="w-full flex justify-center">
        <svg viewBox="0 0 400 500" preserveAspectRatio="xMidYMid meet" className="w-[90%] max-w-[600px] h-auto block">
          ...
          {/* Província: Cuando (menongue) - corrigido */}
          ...
          <text className="cls-3" transform="translate(13.49 34.88) rotate(-46.3)">
            <tspan x="0" y="0" fontSize="7">CABINDA</tspan>
          </text>
          <text className="cls-3" transform="translate(45.28 81.29)">
            <tspan x="0" y="0">ZAIRE</tspan>
          </text>
          <text className="cls-3" transform="translate(111.57 98.84)">
            <tspan x="0" y="0">UÍGE</tspan>
          </text>
          <text className="cls-3" transform="translate(64.56 142.72)">
            <tspan x="0" y="0">BENGO</tspan>
          </text>
          <text className="cls-3" transform="translate(86.48 178.6) rotate(-35.29)">
            <tspan x="0" y="0" fontSize="7">CUANZA-NORTE</tspan>
          </text>
          <text className="cls-3" transform="translate(86.73 230.83)">
            <tspan x="0" y="0">CUANZA-SUL</tspan>
          </text>
          <text className="cls-3" transform="translate(115.27 300.93)">
            <tspan x="0" y="0">HUAMBO</tspan>
          </text>
          <text className="cls-3" transform="translate(57.66 308.31)">
            <tspan x="0" y="0">BENGUELA</tspan>
          </text>
          <text className="cls-3" transform="translate(89.59 367.19)">
            <tspan x="0" y="0">HUÍLA</tspan>
          </text>
          <text className="cls-3" transform="translate(20.57 405.09)">
            <tspan x="0" y="0">NAMIBE</tspan>
          </text>
          <text className="cls-3" transform="translate(111.57 435.56)">
            <tspan x="0" y="0">CUNENE</tspan>
          </text>
          <text className="cls-2" transform="translate(201.37 415.12)">
            <tspan x="0" y="0">CUBANGO</tspan>
          </text>
          <text className="cls-2" transform="translate(276.24 422.74)">
            <tspan x="0" y="0">CUANDO</tspan>
          </text>
          <text className="cls-2" transform="translate(262.9 318.54)">
            <tspan x="0" y="0">MOXICO</tspan>
          </text>
          <text className="cls-2" transform="translate(354.51 279.17)">
            <tspan x="0" y="0" dx="-20">MOXICO LESTE</tspan>
          </text>
          <text className="cls-3" transform="translate(149.82 163.25)">
            <tspan x="0" y="0">MALANJE</tspan>
          </text>
          <text className="cls-3" transform="translate(233.3 161.8)">
            <tspan x="0" y="0">LUNDA-NORTE</tspan>
          </text>
          <text className="cls-3" transform="translate(280.63 216.22)">
            <tspan x="16.9" y="0" dx="-20">LUNDA-SUL</tspan>
          </text>
          <text className="cls-3" transform="translate(175.36 281.65)">
            <tspan x="0" y="0">BIÉ</tspan>
          </text>
          <text className="cls-1" transform="translate(52.17 180.54) rotate(38.88)">
            <tspan x="12.75" y="0" dx="-18" fontSize="7">ICOLO E BENGO</tspan>
          </text>
          <text className="cls-3" transform="translate(22.35 167.25)">
